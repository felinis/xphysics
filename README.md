...
Physics engines are usually written in high-level languages like C++.
The goal of this project is to understand how data-oriented program design principles can be applied to a project where multiple data processing in bulk is crucial. I chose to use C for this project as to absolutely avoid any kind of abstractions introduced by other high-level languages.
